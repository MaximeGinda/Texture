...
int main( void )
{
    ...
    light.setLight();
    glUniform3fv(glGetUniformLocation(programID, "lightPosition"), 1, (GLfloat*) light.position[0]); 
    glUniform3fv(glGetUniformLocation(programID, "lightColor"), 1, (GLfloat*) light.color[0]);
